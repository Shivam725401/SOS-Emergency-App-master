...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  private ActivitySplashScreenBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout back) {
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    LinearLayout back = (LinearLayout) rootView;

    return new ActivitySplashScreenBinding((LinearLayout) rootView, back);
  }
}
